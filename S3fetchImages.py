...
# Connect to S3  
s3 = boto3.client('s3', aws_access_key_id='AKIA2CDQBW6R4LSJFFU4', aws_secret_access_key='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')
bucket_name = 'adm-fashion-images'

# Connect to ChatGPT API
openai.api_key = "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"
...
def form_and_table_understanding(image_path, prompt_text,key):
  ...
  headers = {"Content-Type": "application/json","Authorization": f"Bearer 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"}
  payload = {
